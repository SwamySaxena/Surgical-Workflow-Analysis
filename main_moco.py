...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = moco.builder.MoCo(
        ...
        args.moco_dim, args.moco_k, args.moco_m, args.moco_t, args.mlp,args.predictor,\
    ...
    if args.distill:
        ...
        #t_path = "mocov2base_INpre25_onlyfc0_superTrue_msFalse_numin1024_cat2_dis0_w0"
        #t_path = "mocov2base_INpre25_onlyfc0_superTrue_msFalse_numin2048_cat2_dis0_w0"
        t_path = "mocov2base_INpre25_onlyfc0_superTrue_msFalse_numin512_cat2_dis0_w0"
      
        checkpoint = torch.load(root_path+"/surgical_code/saved_models/cholec80/{}/19.pth.tar".format(t_path))
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        torch.cuda.empty_cache()
        if args.multiprocessing_distributed or (args.multiprocessing_distributed
