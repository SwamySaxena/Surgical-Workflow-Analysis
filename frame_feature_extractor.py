...
dataset_pth = "D:\SEM-VII0\Project\datasets\surgical\workflow"
...
if __name__ == '__main__':
    ...
    # else:
        ...
        framewise_train_dataloader = DataLoader(framewise_traindataset, batch_size=4, shuffle=True, drop_last=False)
        ...
        #         video_folder="test_dataset",sample_rate=args.sample_rate,blacklist=blacklist,split='test')
        framewise_test_dataloader = DataLoader(framewise_testdataset, batch_size=4, shuffle=True, drop_last=False)
...
#         model_path = 'models/{}/inceptionv3/2.model'.format(args.dataset) # use your own model
        ...
        if args.target == 'train_set':
            ...
            framewise_traindataset = dataset.FramewiseDataset(args.dataset, dataset_pth+'/{}'.format(args.dataset),\
                video_folder="train_dataset",sample_rate=args.sample_rate,blacklist=blacklist,transform=None)
            framewise_train_dataloader = DataLoader(framewise_traindataset, batch_size=4, shuffle=False, drop_last=False)
            ...
            framewise_test_dataloader = DataLoader(framewise_testdataset, batch_size=4, shuffle=False, drop_last=False)
